    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 transition-colors">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <Link href={ROUTES.HOME} className="flex justify-center">
          <h1 className="text-4xl font-bold text-blue-600 dark:text-blue-400">{APP_NAME}</h1>
        </Link>
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link href={ROUTES.LOGIN} className="font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">
            Sign in
          </Link>
        </p>
      </div>
